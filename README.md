...
<div align="center" style="display: flex; justify-content: center; align-items: center; gap: 20px; flex-wrap: wrap;">
  <img src="imgs/logo iwasai 2.png" alt="Projeto IWASA'I" style="height: 80px; max-width: 150px; margin: 10px;" />
  <img src="imgs/ufpa.png" alt="UFPA" style="height: 80px; max-width: 150px; margin: 10px;" />
  <img src="imgs/Logo - Colorida.png" alt="Laboratório EngBio" style="height: 80px; max-width: 150px; margin: 10px;" />
</div>

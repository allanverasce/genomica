...
|:---|:---|:---|
| **Baixo (ex: 21)** | Alta sensibilidade em regiões de baixa cobertura. Montagem mais contígua se a profundidade for baixa. | Baixa especificidade; mais propenso a *bifurcações* falsas em regiões repetitivas. |
| **Alto (ex: 127)** | Alta especificidade; resolve repetições longas com mais eficácia. Reduz o número de *contigs* falsos. | Requer alta cobertura (\(> 50\times\)). *Reads* curtos que não atingem o comprimento \(k\) são descartados. |
